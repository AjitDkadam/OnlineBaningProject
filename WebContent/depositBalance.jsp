...
function depositeAmount(){
	if(reqField()){
		document.depositeAmountForm.submit();
	}
}
</script>
<body>
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td>
				...
				<form name="depositeAmountForm" id="depositeAmountForm" action="NewAccountController" method="post" >
				    <input type="hidden" name="docmd" value="depositeAmount">
					...
					<tr>
							<td></td>
							<td><input type="button" class="btn01" value="Submit" onclick="javascript:depositeAmount();">
							<INPUT TYPE=RESET class="btn01"  VALUE="CLEAR"></td>
					</tr>
                   	</table>	
				</form>
			</td>
