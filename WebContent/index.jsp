...
<table cellpadding="0" cellspacing="0" id="content1">
	<tr align="justify">
			<td class="con" valign="top" style="background-color: red;">
		    	<div id="heade1"><h1>Results</h1></div>
		        <p>This is  JIJAU Business bank which is under business and finance category for your website design. AKSoftwareSolutions.com is a free collection of site templates with HTML layouts which are frequently updated.<br><br>
    		...
    		<td class="con" valign="top">
		        ...
		        <p> These JIJAU Business bank would be idle for building a successful online businesses.  Download the required HTML template, install it and edit the existing content with your original text.<br><br>
		    ...
		    <td class="con" valign="top">
		        ...
		        <p>There are various other template categories like Art, Finance, Nature, Night club, Communication, Computer, Music, Religious, Fashion, Holiday, Travel, Health, Medicine. This free JIJAU Business bank which is built using XHTML and CSS.<br>
...
<table style="width:897px; background:#FFFFFF; margin:0 auto;">
	<tr align="justify">
	    ...
	    <td width="299" valign="top">
		        ...
		        <h2>March. 17, 2019.</h2>
		        <p>Get your dream web design at no cost, no extra manpower for your professional website.<br/>@<span style="font-size: 10px;color:#ff471a;">AKSoftware Solutions PVT.LTD.</span></p><br>
		        <div class="img"><img src="images/globe_16.gif" alt="Business"></div>
		        <h2>March. 17, 2019.</h2>
		        <p>Get your dream web design at no cost, no extra manpower for your professional website.<br/>@<span style="font-size: 10px;color:#ff471a;">AKSoftware Solutions PVT.LTD.</span></p>
		      </div>
