...
function depositeAmount(){
	if(reqField()){
		document.withdrawAmountForm.submit();
	}
}
...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td>
				<form name="withdrawAmountForm" id="withdrawAmountForm" action="NewAccountController" method="post">
				   <input type="hidden" name="docmd" value="withdrawAmount">
