...
function reqField(){
	...
	var taccountno = document.getElementById('taccountno').value;
	if(accountNumber != "" || userName != "" || password != "" || amount != "" || taccountno != ""){
		isValid = true;
	}else{
		...
		changeStyleForTextFiled(document.getElementById('amount'),false);
		changeStyleForTextFiled(document.getElementById('taccountno'),false);
		var isValid = false;
	}
	return isValid;
}
...
function depositeAmount(){
	if(reqField()){
		document.transferAmountForm.submit();
	}
...
<tr >
    ...
    <td width="450" valign="top">
		...
		<tr>
			<td>
				<form name="transferAmountForm" id="transferAmountForm" action="NewAccountController" method="post" >
				   <input type="hidden" name="docmd" value="transferAmount">
					...
					<tr>
							<td><span class="labelHeading">Target Account No:</span></td>
							<td>
								<input type="text" name="taccountno" id="taccountno">
								<span style="font-size: 9px;color:#3b60b5;">Account number must be belongs to JIJAU BANK.</span>
							</td>
					</tr>
					<tr>
					...
					<tr>
							<td></td>
							<td>
							<input type="button" class="btn01" value="Submit" onclick="javascript:depositeAmount();">
